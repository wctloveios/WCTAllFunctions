...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
    if([point isKindOfClass:[NSString class]]) {
        ...
        else if([point caseInsensitiveCompare:@"myframe"] == NSOrderedSame) {
...
//        wrapperView.layer.shadowOffset = CSToastShadowOffset;
    ...
    if (title != nil) {
        ...
        CGSize expectedSizeTitle = [title boundingRectWithSize:maxSizeTitle options:0 attributes:@{NSFontAttributeName:titleLabel.font} context:nil].size;
